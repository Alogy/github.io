...
function oddbullet(X,Y){
    bullet.call(this,X,Y,6,14,"../../../src/as/zd.png");
}
...
function ourplan(X,Y){
    var imagesrc="../../../src/as/myfj.png";
    plan.call(this,1,X,Y,66,80,0,660,0,"../../../src/as/myfjbz.png",imagesrc);
...
var yidong=function(){
    ...
    var selfplanX=oevent.clientX-0;
...
function start(){
    ...
    if(mark==20){
        ...
        //中飞机
        if(mark1%5==0){
            enemys.push(new enemy(6,1,274,46,60,20,360,random(1,4),"../../../src/as/bze.png","../../../src/as/20.png"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,57,210,110,164,100,540,1,"../../../src/as/bzb.png","../../../src/as/100.png"));
            mark1=0;
        }
         if(mark1==10){
            enemys.push(new enemy(10,47,110,50,104,50,440,random(1,2),"../../../src/as/bzw.png","../../../src/as/50.png"));
            mark2=0;
        }
        //小飞机
        else{
            enemys.push(new enemy(1,19,286,34,24,10,360,random(1,6),"../../../src/as/bzs.png","../../../src/as/10.png"));
        }
        mark=0;
    }
            ...
            if(enemys[j].planisdie==false){
                if(enemys[j].imagenode.offsetLeft+enemys[j].plansizeX>=selfplan.imagenode.offsetLeft&&enemys[j].imagenode.offsetLeft<=selfplan.imagenode.offsetLeft+selfplan.plansizeX){
                  if(enemys[j].imagenode.offsetTop+enemys[j].plansizeY>=selfplan.imagenode.offsetTop+40&&enemys[j].imagenode.offsetTop<=selfplan.imagenode.offsetTop-20+selfplan.plansizeY){
                      //碰撞本方飞机，游戏结束，统计分数
                      selfplan.imagenode.src="../../../src/as/myfjbz.png";
